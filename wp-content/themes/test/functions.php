...
function theme_name_scripts() {
    ...
    wp_enqueue_style('font-opensans', 'https://fonts.googleapis.com/css?family=Open+Sans:400,600,700');
...
function wptuts_the_breadcrumb(){
    ...
    if(!is_home()){
        ...
        if($pageNum>1)
            echo '<li><a href="'.site_url().'"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li> <li> / </li> '.$pageNum.'- page';
        else
